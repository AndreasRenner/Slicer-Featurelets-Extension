...
FeatureletRegistrationResult::Pointer RegisterVolumes(regImage* FixedImage, regImage* MovingImage )
{
  ...
  regImage::ImageType::SizeType size =
...
FeatureletRegistrationResult::Pointer RegisterVolumes2(regImage *FixedImage, regImage* MovingImage)
{
  ...
  regImage::ImageType::SizeType size = MovingImage->GetImagePointer()->GetLargestPossibleRegion().GetSize();
  ImageType::RegionType region;
  region.SetSize(size);
  registration->SetFixedImage( FixedImage->GetImagePointer() );
  registration->SetMovingImage( MovingImage->GetFeatureletPointer() );
...
FeatureletRegistrationResult::Pointer RegisterVolumesII2(regImage *FixedImage,
                                                          regImage *MovingImage ) {
    typedef regImage::ImageType ImageType;
