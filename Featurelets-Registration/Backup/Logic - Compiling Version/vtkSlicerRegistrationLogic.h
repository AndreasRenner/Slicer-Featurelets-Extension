...
public:
  ...
  FeatureletRegistrationResult::Pointer RegisterVolumes1(ImageType* FixedImage, ImageType* MovingImage);
  FeatureletRegistrationResult::Pointer RegisterVolumes2(ImageType* FixedImage, ImageType* MovingImage);
  FeatureletRegistrationResult::Pointer RegisterVolumesI(ImageType* FixedImage, ImageType* MovingImage);
